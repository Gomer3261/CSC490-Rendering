...
OrbitalLight::OrbitalLight(int lightId, QMatrix4x4 transform, float radius, float z, float rotationRate) :
    m_lightId(lightId),
    m_center(0, 0, z),
...
void OrbitalLight::initializeGL(GLfloat lightSpec[], GLfloat lightDif[], GLfloat lightAmb[])
{
